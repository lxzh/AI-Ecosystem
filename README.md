...
This is a collection of AI projects that gathers and organizes various interesting and useful AI-related projects. Initially, ChatGPT is the main focus, and gradually, other AI projects will be added.
...
---|---|---|---|---|---
[awesome-chatgpt-prompts](https://github.com/f/awesome-chatgpt-prompts)|[Link](https://prompts.chat/)|This repo includes ChatGPT prompt curation to use ChatGPT better.|This is a collection of prompt examples to be used with the ChatGPT model.|![](https://img.shields.io/github/stars/f/awesome-chatgpt-prompts.svg)|![](https://img.shields.io/github/forks/f/awesome-chatgpt-prompts.svg)
...
[chatbot-ui](https://github.com/mckaywrigley/chatbot-ui)||A simple chatbot starter kit for OpenAI's chat model using Next.js, TypeScript, and Tailwind CSS.|一个开发基于ChatGPTAPI的Chatbot模板，技术栈Next.js, TypeScript, and Tailwind CSS. ​​​|![](https://img.shields.io/github/stars/mckaywrigley/chatbot-ui.svg)|![](https://img.shields.io/github/forks/mckaywrigley/chatbot-ui.svg)
...
Name|Urls|About|Description|stars|forks
---|---|---|---|---|---
[ChatGPT-Google](https://github.com/ZohaibAhmed/ChatGPT-Google)||Chrome Extension that Integrates ChatGPT (Unofficial) into Google Search.|Chrome Extension that Integrates ChatGPT (Unofficial) into Google Search.|![](https://img.shields.io/github/stars/ZohaibAhmed/ChatGPT-Google.svg) |![](https://img.shields.io/github/forks/ZohaibAhmed/ChatGPT-Google.svg)
[chat-gpt-google-extension](https://github.com/wong2/chat-gpt-google-extension)|[Install](https://chatgpt4google.com/)|A browser extension that enhance search engines with ChatGPT|A browser extension to display ChatGPT response alongside search engine results.|![](https://img.shields.io/github/stars/wong2/chat-gpt-google-extension.svg)| ![](https://img.shields.io/github/forks/wong2/chat-gpt-google-extension.svg)
...
[chatgpt-chrome-extension](https://github.com/gragland/chatgpt-chrome-extension)||A ChatGPT Chrome extension. Integrates ChatGPT into every text box on the internet.|A Chrome extension that adds ChatGPT to every text box on the internet! Use it to write tweets, revise emails, fix coding bugs, or whatever else you need, all without leaving the site you're on. Includes a plugin system for greater control over ChatGPT behavior and ability to interact with 3rd party APIs.|![](https://img.shields.io/github/stars/gragland/chatgpt-chrome-extension.svg)|![](https://img.shields.io/github/forks/gragland/chatgpt-chrome-extension.svg)
...
[chat-gpt-zhihu-extension](https://github.com/no13bus/chat-gpt-zhihu-extension)|[Install](https://chrome.google.com/webstore/detail/chatgpt-for-zhihu/dgoinfidjelfolhnkaableghhppplbak)|ChatGPT的知乎回答小帮手，利用AI来协助你回答知乎问题|A ChatGPT browser extension on Zhihu can be used as a reference for you to reply to questions, or you can copy the ChatGPT results into the answer editor and modify them accordingly.<p>[Guide](https://www.appinn.com/a-chatgpt-chrome-extension/)|![](https://img.shields.io/github/stars/no13bus/chat-gpt-zhihu-extension.svg)|![](https://img.shields.io/github/forks/no13bus/chat-gpt-zhihu-extension.svg)
[chatgpt-vscode-plugin](https://github.com/barnesoir/chatgpt-vscode-plugin)||A VS code plugin for ChatGPT built by ChatGPT||![](https://img.shields.io/github/stars/barnesoir/chatgpt-vscode-plugin.svg)|![](https://img.shields.io/github/forks/barnesoir/chatgpt-vscode-plugin.svg)
...
Category|Name|Urls|About|Description|stars|forks
---|---|---|---|---|---|---
Github|[chatgpt-action](https://github.com/kxxt/chatgpt-action)||Let ChatGPT review PRs for you||![](https://img.shields.io/github/stars/kxxt/chatgpt-action.svg)|![](https://img.shields.io/github/forks/kxxt/chatgpt-action.svg)
Github|[ChatGPT-ProBot](https://github.com/oceanlvr/ChatGPT-ProBot)||🤖️ A ChatGPT based GitHub robot. dialogue/CR/etc.||![](https://img.shields.io/github/stars/oceanlvr/ChatGPT-ProBot.svg)|![](https://img.shields.io/github/forks/oceanlvr/ChatGPT-ProBot.svg)
...
Wechat|[ChatGPT-wechat-bot](https://github.com/AutumnWhj/ChatGPT-wechat-bot)<p>(停维)||ChatGPT for wechat|A WeChat robot 🤖 based on ChatGPT.|![](https://img.shields.io/github/stars/AutumnWhj/ChatGPT-wechat-bot.svg)|![](https://img.shields.io/github/forks/AutumnWhj/ChatGPT-wechat-bot.svg)
QQ|[chatgpt-mirai-qq-bot](https://github.com/lss233/chatgpt-mirai-qq-bot)||🚀 一键部署！真正的 ChatGPT QQ 聊天机器人！支持ChatGPT API、 ChatGPT Plus、新版 Bing，多账号负载均衡，人设调教，敏感词检测，虚拟女仆、对话上下文，图片渲染，代理加速 (内有视频教程）|OpenAI ChatGPT for Mirai QQ Bot，QQ chat robot.|![](https://img.shields.io/github/stars/lss233/chatgpt-mirai-qq-bot.svg)| ![](https://img.shields.io/github/forks/lss233/chatgpt-mirai-qq-bot.svg)
Telegram|[ChatGPT-Telegram-Bot](https://github.com/yym68686/ChatGPT-Telegram-Bot)||An AI chat Telegram bot with ChatGPT using Python on either fly.io or Replit.|A AI chat Telegram Bot with ChatGPT in fly.io.|![](https://img.shields.io/github/stars/yym68686/ChatGPT-Telegram-Bot.svg)|![](https://img.shields.io/github/forks/yym68686/ChatGPT-Telegram-Bot.svg)
...
Python|[ChatGPT_PyBot](https://github.com/liuhuanshuo/ChatGPT_PyBot)|||ChatGPT_PyBot is a command-line robot developed in Python.|![](https://img.shields.io/github/stars/liuhuanshuo/ChatGPT_PyBot.svg)|![](https://img.shields.io/github/forks/liuhuanshuo/ChatGPT_PyBot.svg)
...
Category|Name|Urls|About|Description|stars|forks
---|---|---|---|---|---|---
ChatGPT-mac|[chatgpt-mac](https://github.com/vincelwt/chatgpt-mac)|[Mac Arm64.dmg](https://github.com/vincelwt/chatgpt-mac/releases/download/v0.0.5/ChatGPT-0.0.5-arm64.dmg)<p>[Mac Intel.dmg](https://github.com/vincelwt/chatgpt-mac/releases/download/v0.0.5/ChatGPT-0.0.5-x64.dmg)|ChatGPT for Mac, living in your menubar.|This is a simple app that makes ChatGPT live in your menubar(MacOS).|![](https://img.shields.io/github/stars/vincelwt/chatgpt-mac.svg)|![](https://img.shields.io/github/forks/vincelwt/chatgpt-mac.svg)
ChatGPT-all pc|[ChatGPT](https://github.com/lencx/ChatGPT)|[Download](https://github.com/lencx/ChatGPT/releases)|ChatGPT Desktop Application (Mac, Windows and Linux)|第三方的 ChatGPT 桌面应用|![](https://img.shields.io/github/stars/lencx/ChatGPT.svg)|![](https://img.shields.io/github/forks/lencx/ChatGPT.svg) 
ChatGPT-all pc|[nofwl](https://github.com/lencx/nofwl)|[Site](nofwl.com)|NoFWL Desktop Application||![](https://img.shields.io/github/stars/lencx/nofwl.svg)|![](https://img.shields.io/github/forks/lencx/nofwl.svg) 
ChatGPT-web|[ChuanhuChatGPT](https://github.com/GaiZhenbiao/ChuanhuChatGPT)|[Site](https://huggingface.co/spaces/JohnSmith9982/ChuanhuChatGPT)|GUI for ChatGPT API|一位B站Up主开发了个川虎ChatGPT，结果可以做到比ChatGPT Plus还快的实时回复。功能特性如下：<p> - 像官方客户端那样支持实时显示回答！<p> - 重试对话，让 ChatGPT 再回答一次。<p> - 优化 Tokens，减少 Tokens 占用，以支持更长的对话。<p> - 设置 System Prompt，有效地设定前置条件；<p> - 保存 / 加载对话历史记录；<p> - 在图形界面中添加 API key；<p> - System Prompt 模板功能；<p> - 实时显示 Tokens 用量。|![](https://img.shields.io/github/stars/GaiZhenbiao/ChuanhuChatGPT.svg)|![](https://img.shields.io/github/forks/GaiZhenbiao/ChuanhuChatGPT.svg)
ChatGPT-Web|typingmind|[Site](https://www.typingmind.com/)|A better UI for ChatGPT|基于 OpenAI chatGPT API 的 ChatGPT 聊天界面， 自带提示库支持，需要自己提供 API Key||
ChatGPT-iOS|OpenCat|[Install](https://apps.apple.com/us/app/opencat/id6445999201?l=zh)|第三方 ChatGPT 原生客户端，即开即用，支持自定义 API 地址|OpenCat 是一款使用 OpenAI API 的 macOS、iOS 原生客户端，即开即用，比官方 Web 版本更加便捷，支持自定义 API 地址。来自熊猫吃短信开发者 `@Baye`||
ChatGPT-Python|[PyChatGPT](https://github.com/rawandahmad698/PyChatGPT)||Python client for the unofficial ChatGPT API with auto token regeneration, conversation tracking, proxy support and more.||![](https://img.shields.io/github/stars/rawandahmad698/PyChatGPT.svg)|![](https://img.shields.io/github/forks/rawandahmad698/PyChatGPT.svg)
ChatGPT-Python|[pandora](https://github.com/pengzhile/pandora)|[Docs](https://zhile.io/2023/02/20/pandora-chatgpt.html)|潘多拉，一个不只是命令行的ChatGPT。|Pandora - 命令行的ChatGPT，实现了网页版ChatGPT的主要操作。`@Neo Peng`|![](https://img.shields.io/github/stars/pengzhile/pandora.svg)|![](https://img.shields.io/github/forks/pengzhile/pandora.svg)
Python|[stackexplain](https://github.com/shobrook/stackexplain)||Explain your error message with ChatGPT||![](https://img.shields.io/github/stars/shobrook/stackexplain.svg)|![](https://img.shields.io/github/forks/shobrook/stackexplain.svg)
Photoshop|[photoshot](https://github.com/shinework/photoshot)|[Site](https://photoshot.app/)|An open-source AI avatar generator web app|An open-source AI avatar generator web app.<p>Note: The online version is charged and can be self-deployed.|![](https://img.shields.io/github/stars/shinework/photoshot.svg)|![](https://img.shields.io/github/forks/shinework/photoshot.svg)
Translate|[openai-translator](https://github.com/LanceMoe/openai-translator)|[Site](https://translator.lance.moe/)|A translator that uses OpanAI.|基于ChatGPT的API做的翻译App|![](https://img.shields.io/github/stars/LanceMoe/openai-translator.svg)|![](https://img.shields.io/github/forks/LanceMoe/openai-translator.svg)
Translate|[bilingual_book_maker](https://github.com/yihong0618/bilingual_book_maker)||Make bilingual epub books Using AI translate|接入AI翻译接口，将epub电子书翻译成双语对照的版本。|![](https://img.shields.io/github/stars/yihong0618/bilingual_book_maker.svg)|![](https://img.shields.io/github/forks/yihong0618/bilingual_book_maker.svg)
Translate|[argos-translate](https://github.com/argosopentech/argos-translate)|[Site](https://www.argosopentech.com/)|Open-source offline translation library written in Python|离线的翻译库，不需要联网就可以实现翻译功能。<p><p>Argos Translate 使用 OpenNMT 进行翻译，可以用作 Python 库、命令行或 GUI 应用程序。 Argos Translate 支持安装语言模型包，它们是带有“.argosmodel”扩展名的 zip 存档，其中包含翻译所需的数据。 LibreTranslate 是建立在 Argos Translate 之上的 API 和网络应用程序。<p><p>Argos Translate 还管理通过中间语言自动旋转以在未安装直接翻译的语言之间进行翻译。例如，如果您安装了 es → en 和 en → fr 翻译，您可以从 es → fr 进行翻译，就好像您安装了该翻译一样。这允许以损失翻译质量为代价在多种语言之间进行翻译。<p><p>支持的语言：阿拉伯语、阿塞拜疆语、加泰罗尼亚语、中文、捷克语、丹麦语、荷兰语、英语、世界语、芬兰语、法语、德语、希腊语、希伯来语、印地语、匈牙利语、印度尼西亚语、爱尔兰语、意大利语、日语、韩语、波斯语、波兰语、葡萄牙语、俄语、斯洛伐克语、西班牙语、瑞典语、土耳其语、乌克兰语|![](https://img.shields.io/github/stars/argosopentech/argos-translate.svg)|![](https://img.shields.io/github/forks/argosopentech/argos-translate.svg)
...
#### Let ChatGPT help you make PPT from scratch with zero foundation

1. Describe your requirements to ChatGPT and let it write a VBA code for you. The clearer the requirements, the better (see Figure 2)(If the requirements are not clear, it is better to do it yourself.).
2. Open PPT and enable the "Developer Tools" in the custom ribbon (see Figure 3).
3. Click on "Visual Basic" in the Developer Tools, create a new module, paste the code in, and click "Run" to complete the task (see Figure 4).

If there are any problems, provide feedback in the tone of the requesting party and be sure to indicate the specific error.

- Common Problem 1: If an error occurs during execution, provide feedback to AI for correction (see Figure 5).
- Common Problem 2: Due to the frequent disconnection of the free version, simply refresh the page to allow 
AI to continue writing (see Figure 6).
...
#### The free ChatGPT gpt-3.5-turbo API is now available
...
ChatPDF is a replacement for Humata (humata.ai) with the same functionality, but with a page limit of 60. Using both applications can be cross-referenced to avoid errors or omissions.

## ChatExcel

chatexcel.com

The team at Peking University has created a similar application, but it uses Excel and allows for any adjustments to be made through natural language commands. It calls the OpenAI Tabulate API service, which is specifically designed for table processing.
Unfortunately, this is only a demo, and it only supports Excel files within 1MB and no more than 10 columns, with no paid options, which is very limiting.
...
The knowledge base tool led by OpenAI is lighter than Notion. Use it as a storage box for daily information intake. After throwing it in, AI will chew and organize it, generating new briefings for me.

## HARPA

harpa.ai

The Chrome browser plugin not only calls ChatGPT to summarize the current page at any time but also integrates many automation functions. For example, you can let it track the prices of products in an online store and notify you as soon as they drop to the number you set.
Because there are many types of functions, it may be cumbersome to use, and you need to constantly adjust it in the early stage or simply abandon unnecessary options and use its page perception ability, which is incredibly versatile.

## HOTOKE AI

hotoke.ai

The AI Buddhist master is similar to ChatPDF. Input a question, retrieve Buddhist scriptures, and use ChatGPT to answer. It feels like documents and publications need to be embedded once again.
...
Category|Apps
---|---
Writing|copy.ai<p>writemaster.ai<p>copymatic.ai
Picture|openai.com/dall-e-2/<p>deepai.org<p>lexica.art
Icon /UI Design|logo.com<p>lordicon.com<p>uiverse.io
Video/Editing|runwayml.com<p>veed.io
Dubbing|murf.ai<p>typecast.ai
Program|tabnine.com<p>|beta.openai.com/examples
Tools|Intelligent naming: namelix.com<p>The Foley Kee Killer (for research purposes only): pornpen.ai
Aggregation function|gpt3demo.com/map<p>futuretools.io/?tags-n5zn=fin…<p>futurepedia.io<p>allthingsai.com
