...
分类|名称|链接|关于|描述|stars|forks
---|---|---|---|---|---|---
ChatGPT-mac|[chatgpt-mac](https://github.com/vincelwt/chatgpt-mac)|[Mac Arm64.dmg](https://github.com/vincelwt/chatgpt-mac/releases/download/v0.0.5/ChatGPT-0.0.5-arm64.dmg)<p>[Mac Intel.dmg](https://github.com/vincelwt/chatgpt-mac/releases/download/v0.0.5/ChatGPT-0.0.5-x64.dmg)|ChatGPT for Mac, living in your menubar.|这是一个简单(mac)应用程序，将 ChatGPT 集成到你的菜单栏。|![](https://img.shields.io/github/stars/vincelwt/chatgpt-mac.svg)|![](https://img.shields.io/github/forks/vincelwt/chatgpt-mac.svg)
...
ChatGPT-all pc|[gpt4all-chat](https://github.com/nomic-ai/gpt4all-chat)|[Site](https://gpt4all.io/index.html)|gpt4all-j chat|GPT4All Chat，一个本地运行的人工智能聊天应用程序，不需要联网。已经被打包好了，直接下载即可使用。默认使用GPT-J模型，用CPU计算。能力可能和gpt-3差不多。|![](https://img.shields.io/github/stars/nomic-ai/gpt4all-chat.svg)|![](https://img.shields.io/github/forks/nomic-ai/gpt4all-chat.svg) 
ChatMLX-mac|[ChatMLX](https://github.com/maiqingqiang/ChatMLX)|[Install](https://github.com/maiqingqiang/ChatMLX/releases)|ChatMLX is a modern, open-source, high-performance chat application for MacOS based on large language models.|ChatMLX 是一款现代化的开源高性能聊天应用，基于大型语言模型，依托于强大的MLX和 Apple silicon。它支持多种模型，为用户提供丰富多样的对话选项。该应用在本地运行 LLM，以确保用户隐私和安全。<p><p> - 多语言：支持英语、简体中文、繁体中文、日语和韩语。<p> - 多个模型：提供多个模型，包括 Llama、OpenELM、Phi、Qwen、Starcoder 和 Cohere。<p> - 高性能：基于 MLX 和 Apple silicon 的强大性能。<p> - 隐私与安全：在本地运行 LLM，以确保用户隐私和安全。|![](https://img.shields.io/github/stars/maiqingqiang/ChatMLX.svg)|![](https://img.shields.io/github/forks/maiqingqiang/ChatMLX.svg)
...
ChatGPT-Python|[PyChatGPT](https://github.com/rawandahmad698/PyChatGPT)||Python client for the unofficial ChatGPT API with auto token regeneration, conversation tracking, proxy support and more.|非官方 ChatGPT API 的 Python 客户端，具有自动令牌再生，会话跟踪，代理支持等特性。|![](https://img.shields.io/github/stars/rawandahmad698/PyChatGPT.svg)|![](https://img.shields.io/github/forks/rawandahmad698/PyChatGPT.svg)
...
Python|[stackexplain](https://github.com/shobrook/stackexplain)||Explain your error message with ChatGPT|让 ChatGPT 来帮你解释（Python）错误信息。|![](https://img.shields.io/github/stars/shobrook/stackexplain.svg)|![](https://img.shields.io/github/forks/shobrook/stackexplain.svg)
Photoshop|[photoshot](https://github.com/shinework/photoshot)|[Site](https://photoshot.app/)|An open-source AI avatar generator web app|一个开源的AI头像生成器web应用程序。<p>注: 在线版本收费，可以自行部署。|![](https://img.shields.io/github/stars/shinework/photoshot.svg)|![](https://img.shields.io/github/forks/shinework/photoshot.svg)
...
TTS|[ChatTTS](https://github.com/2noise/ChatTTS)|[Site](https://2noise.com/)<p>[Demo](https://chattts.com/zh)|A generative speech model for daily dialogue.|AI 文字转语音工具。<p>生成的语音自然流畅，很真实自然，而且能生成多人对话。|![](https://img.shields.io/github/stars/2noise/ChatTTS.svg)|![](https://img.shields.io/github/forks/2noise/ChatTTS.svg)
